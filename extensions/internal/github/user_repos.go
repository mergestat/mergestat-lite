...
var userReposCols = []vtab.Column{
	...
	{Name: "created_at", Type: "TEXT", OrderBy: vtab.ASC | vtab.DESC},
	...
	{Name: "is_archived", Type: "INT"},
	{Name: "is_disabled", Type: "INT"},
	{Name: "is_fork", Type: "INT"},
	{Name: "is_mirror", Type: "INT"},
	{Name: "is_private", Type: "INT"},
	{Name: "issue_count", Type: "INT"},
	{Name: "latest_release_author", Type: "TEXT"},
	{Name: "latest_release_created_at", Type: "TEXT"},
	{Name: "latest_release_name", Type: "TEXT"},
	{Name: "latest_release_published_at", Type: "TEXT"},
	...
	{Name: "pushed_at", Type: "TEXT", OrderBy: vtab.ASC | vtab.DESC},
