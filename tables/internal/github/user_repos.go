...
type fetchAllReposResults struct {
	UserRepos   []*repo
	HasNextPage bool
...
func fetchUserRepos(ctx context.Context, input *fetchUserReposOptions) (*fetchAllReposResults, error) {
